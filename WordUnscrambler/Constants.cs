...
namespace WordUnscrambler
{
    public class Constants
    {
        ...
        public const string EnterScrambledWordsManually = "Enter word(s) manually (seperate by commas if multiple): ";
        ...
        public const string ErrorProgramWillBeTerminated = "The prgoram will be terminated";
